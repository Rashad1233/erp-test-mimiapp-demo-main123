  ...
  fetch('/api/clients')
    ...
    .then(data => {
      ...
      if (!data.clients || data.clients.length === 0) {
        tableBody.innerHTML = `<tr><td colspan="6" class="text-center">${getTranslation('noClientsFound', 'No clients found')}</td></tr>`;
        return;
      }
        ...
        row.innerHTML = `
          ...
          <td>
            <div class="action-buttons">
              <button class="action-btn view-btn" data-id="${client.id}" data-i18n="view"><i class="fas fa-eye"></i> ${getTranslation('view', 'View')}</button>
              <button class="action-btn edit-btn" data-id="${client.id}" data-i18n="edit"><i class="fas fa-edit"></i> ${getTranslation('edit', 'Edit')}</button>
              <button class="action-btn delete-btn" data-id="${client.id}" data-i18n="delete"><i class="fas fa-trash"></i> ${getTranslation('delete', 'Delete')}</button>
            </div>
          </td>
        `;
